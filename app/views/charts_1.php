                  ...
                  <ul class="recent-posts">
                    <li style="margin-top: 7px;">
                      ...
                      <div class="article-post">
                        <p style="margin-top: 5px;"> 账户名称： <span style="color: #FE201D;"><strong>{%$access_log.operator%}</strong></span></p>
                      </div>
                    </li>
                    <li style="margin-top: 7px;">
                      ...
                      <div class="article-post">
                        ...
                        <p style="margin-top: 5px;"> 上次登录时间：{%$access_log.accesstime%} &nbsp; IP： <span style="color: #FE201D;">{%$access_log.ip%}</span></p>
                      </div>
                    </li>
                    <li style="margin-top: 7px;">
                      <div class="user-thumb" style="margin-top: -7px;"> <img width="40" height="40" src="/dist/img/av3.jpg" alt="User"> </div>
                      <div class="article-post">
                        <p style="margin-top: 5px;"> 累加发送量：<span style="color: #FE201D;">{%$send_num%}</span> 封</p>
                      </div>
                    </li>
                    <li style="margin-top: 7px;margin-bottom: 3px;border-bottom:0;">
                      ...
                      <div class="article-post">
                        <p style="margin-top: 5px;"> 日均发送量：<span style="color:#FE201D;">{%$avg_num%}</span> 封</p>
                      </div>
                    </li>
                  </ul>
      ...
      <div class="span2">
        <div class="widget-box">
          ...
          <div class="widget-content" style="padding: 0;">
            <div>
                  <ul class="recent-posts">
                    <li style="padding-top: 20px;padding-bottom: 21px;text-align: center;">全部联系人 <span style="color: #FE0200;font-weight:700 ;">{%$contact_info.person_num%}</span> 个</li>
                    <li style="padding-top: 20px;padding-bottom: 22px;text-align: center;">联系人组 <span style="color: #27B779;font-weight:700 ;">{%$contact_info.group_num%}</span> 个</li>
                    <li style="padding-top: 20px;padding-bottom: 23px;text-align: center;">任务数量 <span style="color: #23ACE2;font-weight:700 ;">{%$contact_info.task_num%}</span> 个</li>
                    <li style="padding-top: 20px;padding-bottom: 25px;text-align: center;border-bottom:0;">模版数量 <span style="color: #FFB649;font-weight:700 ;">{%$contact_info.tpl_num%}</span> 个</li>
                  </ul>
            </div>
          </div>
        </div>
          ...
          <div class="widget-content" style="padding: 0;">
            <div>
              <ul class="unstyled" style="margin-top: 5px; margin-bottom: 8px;">
                  {%for $i=0 to 3%}
                    {%if $task_status[$i] neq []%}
                      <li style="width: 100%;min-height: 60px;">
                          <div>
                              <div style="width:23%;min-height: 50px;float: left;line-height: 50px;padding-left: 10px;text-align: left;">
                                  <a title="{%$task1.task_name%}">{%$task_status[$i].task_name|truncate:7:"..."%}：</a>
                              </div>
                              <div class="progress progress-danger progress-striped " style="float: left;width: 73%;min-height: 20px;margin-bottom: 5px;margin-top: 12px;">
                                  <div class="bar" style="width: {%$task_status[$i].progress%};"></div>
                              </div>
                              <div style="width: 73%;min-height: 20px;float: left;">
                                  <span class="icon24 icomoon-icon-arrow-up-2 green">{%$task_status[$i].progress%}进度;</span>
                                  <span class="icon24 icomoon-icon-arrow-up-2 green">{%$task_status[$i].completion_rate%}成功率</span>
                                  <span class="pull-right strong">总量{%$task_status[$i].total%} &nbsp;&nbsp;&nbsp; 成功{%$task_status[$i].success%}</span>
                              </div>
                          </div>
                      </li>
                    {%else%}
                    <li style="width: 100%;min-height: 60px;">
                        <div>
                            ...
                            <div style="width: 73%;min-height: 20px;float: left;">
                                <span class="icon24 icomoon-icon-arrow-up-2 green">0%进度;</span>
                                <span class="icon24 icomoon-icon-arrow-up-2 green">0%成功率</span>
                                <span class="pull-right strong">总量0 &nbsp;&nbsp;&nbsp;&nbsp;成功0</span>
                            </div>
                        </div>
                    </li>
                    {%/if%}
