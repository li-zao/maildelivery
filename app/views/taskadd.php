...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"><a href="/createtem/firstpage" title="返回首页" class="tip-bottom"><i class="icon-home"></i> 首页</a><a href="#"> 投递任务管理</a><a href="#" class="current">创建任务</a></div>
  </div>
			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content">
						<form id="formAdd" action="" method="post" onkeydown="if(event.keyCode==13){return false;}">
						<input type="hidden" name="createtime" value="{%$currtime%}" id="currtime">
						<input id="userid" type="hidden" name="uid" value="{%$uid%}">
						<input type="hidden" name="gnames" value="" id="groupid" />
						<input type="hidden" name="tnum" value="" id="tnum" />
						<input type="hidden" name="fid" value="" id="filtersId" />
						<input type="hidden" name="path" value="" id="filepath" />
						<input type="hidden" name="filename" value="" id="oldname" />
						<input type="hidden" id="draft" name="draft" value=""/>
						<table class="table">
							 <tbody>
								<tr>
									<td colspan="4" style="text-align: left;border:0;padding: 8px 0px;">
										<p style="border-bottom: 1px solid #A4A4A4;display: block;height: 26px;width: 100%;"><span style="border-radius: 5px 5px 0 0;background: none repeat scroll 0 0 #A4A4A4;color: #FFFFFF;display: block;font-size: 12px;font-weight: bold;height: 26px;line-height: 26px;text-align: center;width: 10%;">基本信息</span></p>
									</td>
								</tr>
								...
								<tr>
									<td colspan="2" style="text-align: left;padding: 0;border:0;padding-top:0;" >
										<input type="text" id="taskname" name="task_name" value="新建任务_{%$currtime%}" onblur="check_plan(this.value);" style="border: 1px solid rgb(191, 191, 191); line-height: 25px; width: 99.3%; padding: 0px 0px 0px 4px; margin-bottom: 0px; height: 25px;font-size:12px;">
										<div  id="checktaskname" style="width:100%;text-align:left;background: none repeat scroll 0 0 #E8E8E8;color: #999999;font-size: 12px;line-height: 27px;padding-left:2px;vertical-align: top;">&nbsp;仅内部使用 示例："活动策划2014-04-08#4" </div>
									</td>
									<td colspan="2" style="text-align: left;padding: 0;border:0;padding-top:0;" >
										<select name="cid" id="tasktype" style="border: 1px solid rgb(191, 191, 191); height:25px;line-height: 25px;padding-left:4px 0 0; width: 97%; margin-bottom: 0px;font-size:12px;margin-left: 15px;"><option value="0">选择</option>
								...
								<tr>
									<td style="width: 21%;text-align:left;border:0;padding-left:0px;padding-top: 0px;">
										<input type="text" id="sender" name="sender" value="{%$sender%}" style="border: 1px solid rgb(191, 191, 191); line-height: 25px; width: 98.4%; padding: 0px 1px 0px 2px; margin-bottom: 0px; height: 25px;font-size:12px;">
										<div  style="width:100%;text-align:left;background: none repeat scroll 0 0 #E8E8E8;color: #999999;font-size: 12px;line-height: 27px;padding:0;vertical-align: top;padding-left:2px;">&nbsp;让收件人知道您是谁</div>										
									</td>
									<td style="width: 39%;text-align:left;border:0;padding-left:0px;padding-top: 0px;">
										<input type="text" id="sendemail" name="sendemail" value="{%$sendemail%}" style="background-color:#fff;border: 1px solid rgb(191, 191, 191); line-height: 25px; width: 98.4%; padding: 0px 1px 0px 4px; margin-bottom: 0px; height: 25px;font-size:12px; margin-left: 8px;"/>
										<div  style="width:100%;text-align:left;background: none repeat scroll 0 0 #E8E8E8;color: #999999;font-size: 12px;line-height: 27px;padding:0;vertical-align: top;padding-left:2px; margin-left: 8px;">&nbsp;收件人会看到的您的邮件地址</div>										
									</td>
									<td colspan="2" style="text-align:left;border:0;padding-left:0px;padding-top: 0px;padding-right: 0px;">
										<input type="text" id="replyemail" name="replyemail" value="{%$sendemail%}" style="border: 1px solid rgb(191, 191, 191); line-height: 25px; width: 95%; padding: 0px 2px 0px 4px; margin-bottom: 0px; height: 25px;font-size:12px; margin-left: 15px;">
								...
								<tr>
									<td colspan="4" style="text-align:left;border:0;font-weight: bold;padding-left:0px;padding-bottom: 5px;">邮件主题：
								...
								<tr>
									<td colspan="4" style="width:100%;text-align:left;border:0;padding-left:0px;padding-top:0;">
										<input type="text" id="subject" name="subject" value="" style="border: 1px solid rgb(191, 191, 191); line-height: 25px;  width:100%; padding: 0px 2px 0px 4px; margin-bottom: 0px; height: 25px;font-size:12px;">
										<div  style="width:100%;text-align:left;background: none repeat scroll 0 0 #E8E8E8;color: #999999;font-size: 12px;line-height: 27px;padding: 0px 6px 0px 2px;vertical-align: top;padding-left:2px;">&nbsp;示例：缤纷夏日 省心省力。用途：显示在用户收件箱中的主题，请用心哦，这样才会提高打开率！</div></td>
								</tr>	
								<tr><td colspan="4" style="text-align:left;border:0;padding-left:0px;padding-top:0;padding-top: 4px; padding-bottom: 0px;">
										<input type="checkbox" checked="checked" value="1" style="margin-right:5px;margin-top: 0px;height: 20px;" id="is_insert_ad" name="is_insert_ad">
								...
								<tr><td colspan="4" height="32" style="text-align: left; padding: 0px;border:0;">
									<table width="100%">
										<tbody>
											<tr>
												<td width="7.6%" height="30" style="font-size: 12px;font-weight: bold;text-align: left;padding: 0;border:0;">邮件地址：</td>
												<td width="93%" style="text-align: left;padding:8px 0;border:0;">
													<table width="100%">
														<tbody>
															<tr>
																...
																<td style="width:75%;text-align: left;padding:0;border:0;font-size:14px;">选择的地址个数：<span id="email_count">0</span>
																<span style="text-align: left;padding:0;border:0;font-size:12px;color:#999999;">&nbsp;&nbsp;&nbsp;*选择多个组时，个数显示不去重</span></td>
															</tr>
														</tbody>
													</table>
												</td>
								...
								<tr>
									<td id="selperson" colspan="4" style="text-align: left; padding: 0px 8px 0px 0px;border:0;font-size:12px;"></td>
								</tr>
								<tr>
									<td colspan="4" style="text-align: left;padding: 0px 8px 0px 0px;border:0;font-size:12px;padding-rignt:8px;"><textarea style="padding: 5px 3px; width: 100%;resize: none;" rows="5" cols="80" id="email_list" name="email_list">{%$mailbox%}</textarea></td>
								</tr>		
								<tr>
								...
								<tr>
									<td colspan="4" style="width:20%;text-align: left; padding: 8px 0px 8px 0px;border:0;font-weight: bold;">
										<span style="display: block;float:left;height: 24px;line-height: 24px;">选择筛选器：&nbsp;&nbsp;</span>
										<a style="background: none repeat scroll 0 0 #E6E6E6;border: 1px dashed #ACACAE;border-radius: 5px;display: block;float:left;font-size: 12px;padding: 0 10px;text-align: center;cursor:pointer;height:22px;line-height:22px;line-height:23px\9;width: 110px;" id="s_filter" href="#selectfilter" role="button" data-toggle="modal">选择一个筛选器</a>
										<div id="appendsfilter" style="margin: 3px 0px;display: block;float:left;height: 24px;line-height: 24px;margin: 3px 0px 3px 20px;"></div>
									</td>
								</tr>
								<tr>
									<td colspan="4" style="text-align: left;padding: 8px 0;border:0;font-weight: bold;">
										...
										<!--获取网络模板-->
										<a style="width:7%;display: block;background: #e6e6e6;border: 1px dashed #acacae;border-radius: 5px;font-size: 12px;height:22px;line-height:23px;text-align: center;padding: 0 10px;float: left;margin-right: 9px;" href="#load_site" data-toggle="modal">网站获取</a>
										<div id="load_site" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:42%;">
												...
												<div class="modal-body">					
													...
													<p style="margin-left: 40px;text-align: left;padding:0;border:0;font-size:12px;color:#999999;">*(除带有Javascript、Flash、内嵌窗口等大部分URL)</p>
												</div>					
										...
										<div id="load_file" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:42%;">
											<!--<form action="/task/designtask" method="post">-->
												...
												<div class="modal-body">					
													...
													<p style="text-align: left;padding:0;border:0;font-size:12px;color:#999999;">*(上传文件类型为：html，htm，大小不超过200K)</p>
												</div>										
												<div class="modal-footer">
										...
										<!--选择模板-->
							<!-- <a id="load_public_template" style="width:7%;height: 20px;display: block;background: #e6e6e6;border: 1px dashed #acacae;border-radius: 5px;font-size: 12px;line-height: 20px;text-align: center;padding: 0 10px;float: left;margin-right: 9px;" href="javascript:void(0);">选择模板</a> -->
							...
							<a id="load_public_template" style="width:7%;display: block;background: #e6e6e6;border: 1px dashed #acacae;border-radius: 5px;font-size: 12px;height:22px;line-height:22px;line-height:23px\9;text-align: center;padding: 0 10px;float: left;margin-right: 9px;" href="#seltpl" data-toggle="modal">选择模板</a>
										...
										<a style="background: none repeat scroll 0 0 #E6E6E6;border: 1px dashed #ACACAE;border-radius: 5px;display: block;float:left;font-size: 12px;padding: 0 10px;text-align: center;cursor:pointer;height:22px;line-height:22px;line-height:23px\9;width: 80px;" id="s_subscription" href="#selectsubscription" role="button" data-toggle="modal">选择订阅</a>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<!-- 附件：<input type="file" style="width:25%;border: 1px solid #BFBFBF;height: 25px;line-height: 20px;font-size:12px;padding-left: 5px;" name="filename" id="fileupload_app"> -->
				    ...
				    <div id="attachs" class="modal hide fade" style="width:600px;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="top:5%">
						...
						<div class="modal-body" id="appendattach">
							...
							<tbody id="attachmentlist">
								...
								<tr id="page"><td colspan="3" style="text-align:center"><div class="fenpages" style="float:left; margin-top: 20px; margin-left: 45px;"></div><div class="holder" style="float:left;"></div></td></tr>
							</table>
						</div>
						<div class="modal-footer">
...
function delattch(obj){
		...
		var t='tag';
		$.post('/task/delattch',{'delid':val,'path':path,'del':t},function(data){
			if(data == 'ok'){
		...
		var con='';
			$.post('/task/searchattach',{'searchattach':searchattach,'attachname':attachname},function(data){
				...
				$('#attachs').modal('show');
								...
								<tr>
									<td colspan="4" style="text-align: left;padding: 0px 10px 0px 20px;border:0;line-height:20px;font-size: 13px;"><label class="checkbox inline" style="padding-top: 0px;color: #999999;font-size: 12px;vertical-align: middle;"><input style="margin-top: 1px;" type="checkbox" id="report" name="isreport" value="1"></label><label style="cursor:pointer">是否接收任务报告</label>
								</td>
								</tr>
								<tr>
									<td colspan="4" style="text-align: left;padding: 0px 10px 0px 20px;border:0;font-weight: bold;line-height:20px;font-size: 13px;">	
									接收地址：<input class="inwbk_re" type="text" style="width:92%;" value="{%$sendemail%}" name="reportemail" id="reportemail"></td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan="4" style="text-align: left;padding: 0px 10px 0px 20px;border:0;font-weight: bold;line-height:20px;font-size: 13px;">随机发送：<label class="checkbox inline" style="padding-top: 0px;color: #999999;font-size: 12px;vertical-align: middle;"><input type="checkbox" id="random" name="random" value="1" checked> 当选中此项时将会以随机打散的方式为您发送该任务，这样可以很大提升邮件的到达率</label></td>
								</tr>
								<tr>
									<td colspan="4" style="text-align: left;padding: 8px 10px 0px 20px;border:0;font-weight: bold;line-height:20px;font-size: 13px;"><span style="float: left;display: inline-block;">发送计划：</span><label class="radio" style="margin-left: 20px;"><input type="radio" name="is_server_send" id="optionsRadios1" value="0" checked>立即</label>
										<label class="radio" style="margin-left: 50px;"><input type="radio" name="is_server_send" id="optionsRadios2" value="1">定时</label>
										<label class="radio" style="margin-left: 50px;"><input type="radio" name="is_server_send" id="optionsRadios3" value="2">周期</label>
									</td>
								...
								<tr>
									<td colspan="4" style="text-align: left;padding: 10px 10px 0px 90px;border:0;line-height:20px;font-size: 12px;">
										<!--立即发送-->
										<div  id="now_send" style="line-height:25px;border: 2px dotted #CCCCCC; width: 76%; padding: 10px; display: block;"> 您的任务将在审核通过后开始发送。如果需要跳过审核步骤直接发送任务，请联系管理员。 </div>
										<!--定时发送-->
										<div id="timer_send" style="line-height: 25px; border: 2px dotted rgb(204, 204, 204); width: 76%; padding: 10px; display: none;">请设置发送时间：<div class="input-append date form_datetime" style="margin-right: 1px;margin-top: -4px;"><input size="16" name="start_time" id="start_time" type="text" value="" onfocus="" style="width:196px;" readonly><span class="add-on" style="padding-bottom: 0px\9;height:19px\9;"><i class="icon-calendar"></i></span></div><br/>定时计划会在您设定的时间开始尝试发送邮件。在此之前，您还可以撤销发送计划对邮件进行编辑。
										</div>
										<!--周期发送-->
										<div id="cycle_send" style="line-height: 25px; border: 2px dotted rgb(204, 204, 204); width: 76%;padding: 10px;display: none;">
										发送时间：<select id="cycle_time" name="cycle_time"  style="padding: 0px; width: 65px; height: 20px; margin-bottom: 5px;">
												...
												&nbsp;结束时间：<div class="input-append date form_date" style="padding-top: 0px; margin-right: 1px;margin-top: -4px;"><input size="16" name="next_end_time" id="next_end_time" type="text" value="" onfocus="" style="width:196px;" readonly><span class="add-on" style="padding-bottom: 0px\9;height:19px\9;"><i class="icon-calendar"></i></span></div>
												<table width="100%">
													<tbody><tr>
														<td width="220px" style="text-align: left;padding:0;border:0;">
															<label><input name="cycle_type" type="radio" value="1" style="margin-top: 3px; margin-right: 10px;" checked>每天</label>
														</td>
														<td width="220px" style="text-align: left;padding:0;border:0;font-size:12px;">
															<label style="width: 55px;float:left"><input name="cycle_type" type="radio" style="margin-top: 3px; margin-right: 10px;" value="2">每周</label>
															<select id="cycle_week" name="cycle_week" style="display: none;width: 85px; font-size:12px;padding: 0px; height: 20px;">
																...
																<option value="15">周一至周五</option>
																<option value="67">周六至周日</option>
															</select>
														</td>
														<td style="text-align: left;padding:0;border:0;">
															<label style="width: 55px;float:left"><input name="cycle_type" type="radio" style="margin-top: 3px; margin-right: 10px;" value="3">每月</label>
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div  class="modal-body">
		...
		<!--<input type="hidden" name="import" value="import" />-->
			...
			<!--<tr height="40px">
				<td><b>分隔符：</b></td>
				<td><input type="radio" style="margin-top:0px;" checked name="subchar" value="1" />逗号&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" style="margin-top:0px;" name="subchar" value="0" />空格</td>
			</tr>-->
			<tr height="40px">
				<td><b>联系人组：</b></td>
		...
		<div  class="modal-body">
			...
			<table width="100%" align="center">
				<tr class="modal-header" style="font-size:14px;">
					<td width="25%" style="text-align:center">选项</td>
					<td width="35%" style="text-align:center">组名称</td>
					<td width="40%" style="text-align:center">联系人数</td>
				</tr>
				<tr>
					<td width="25%"><input type="checkbox" name="gname[]" id="checkAll" value="all" style="margin-left:64px">&nbsp;全选</td>
					<td width="35%" style="text-align:center">全部联系人</td>
					<td width="40%" style="text-align:center">{%$count%}</td>
				</tr>
				...
				<tr><td colspan="3" style="text-align:center"><div class="fenpages" style="float:left; margin-top: 20px; margin-left: 35px;"></div><div class="holder" style="float:left;"></div></td></tr>
			</table>
		</div>
		<p> </p>
		<div class="modal-footer">
...
<div id="myModal3" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form action="addtask" method="post" enctype="multipart/form-data" id="myform">
		<div class="modal-header">
			<button class="close" aria-hidden="true" data-dismiss="modal" type="button">×</button>
...
<div id="selectfilter" style="width:600px" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div  class="modal-body">
			...
			<table width="100%" align="center" class="table table-striped">
				...
				<tr><td colspan="2" style="text-align:center"><div class="fenpages" style="float:left; margin-top: 20px; margin-left: 70px;"></div><div class="holder" style="float:left;"></div></td></tr>
			</table>
		</div>
		<p> </p>
		<div class="modal-footer">
...
<!--<input type="hidden" id="uploadExcelGroup" value="{%$uploadExcelGroup%}">-->
<script type="text/javascript">
$(function(){
	/*var uploadExcelGroup = $("#uploadExcelGroup").val();
	if (uploadExcelGroup != "") {
		var s="";
		s="<span href='#myModal3' role='button' onclick='postval(this)' data-toggle='modal' id='"+uploadExcelGroup+"'><a href='javascript:person("+uploadExcelGroup+")' id='"+uploadExcelGroup+"'>"+uploadExcelGroup+"</a>&nbsp;&nbsp;&nbsp;</span><a name='"+uploadExcelGroup+"' class='icon-remove' onclick='del(this)' id='del_"+uploadExcelGroup+"' href='javascript:void(0)'></a>&nbsp;&nbsp;&nbsp;&nbsp;";
		if(s != ''){
			$("#selperson").html(s);
		}
		$.ajax({
		...
		$("#groupid").attr('value',uploadExcelGroup);
		var filtersId=$("#filtersId").val();
		var uploadExcelGroup = $("#uploadExcelGroup").val();
		if(filtersId != ''){
			$.post('/task/selectfilter',{'fid':filtersId,'groups':uploadExcelGroup},function(data){
				if(data){
					$("#email_count").text(data);
					$("#tnum").val(data);
				}
	...
	function delfilter(obj){
		...
		$.post('/task/selectfilter',{'fid':'','groups':groupid},function(data){
			if(data){
				$("#email_count").text(data);
				var filtersname=$("input[name='filtersId[]']:checked").removeAttr("checked");
			}
		})
	}
...
$(function(){
	...
	function onblur(event) {
		check_plan(this.value);
	}
	
	//异步判断任务名称是否重复
	function check_plan(taskname){
		//ajax验证分类是否重复,不重复新建
		var taskname=taskname;
		var uid=$('#userid').val();
		if (taskname!=''){
			$.post('/task/checktask',{'taskname':taskname,'uid':uid},function(data){
				//alert(data);
				//如果调用php成功
					if(data ==  'error'){
						$("#taskname").val("").focus();
...
$(function(){
	...
	$('#send_btn').on('click', function(){
        var sendto_num = $("#email_count").text();
		//验证任务名称
		...
		if(sender.length < 2 || sender.length > 20){
			art.dialog.alert('请输入至少2位的用户名（字数范围2-20）');
			return false;
		}
		...
		if(email_list == "" && groupid == ""){
			art.dialog.alert('邮件地址不能为空');
			return false;	
		}
        if(email_list == "" && sendto_num == "0"){
	...
	/* function checkEndTime(){
		...
		var next_end_time=$('#next_end_time').val();
		if(next_end_time != ''){
			var end=tostrings(next_end_time);
			var today=GetDate();
			if(end < today){
				art.dialog.alert('选择周期发送任务时，请设置结束时间大于当前时间!');
				return false;
			}
			return true;  
		}
	...
	function ReplaceSeperator(str) {
		...
		var c;
		var arr=str.split(","); 
		//var content = email_list.replace("\n",",");
		var reg = /^\w+((-\w+)|(\.\w+))*\@[A-Za-z0-9]+((\.|-)[A-Za-z0-9]+)*\.[A-Za-z]+$/;
   ...
   function stpl(obj){
	...
	$(function(){
		...
		$("#variable2").click(function(){
			...
			$("#subject").attr("value",subject+str);
		})
	})
</script>
<!--Footer-part-->
